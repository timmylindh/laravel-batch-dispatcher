...
namespace Timmylindh\LaravelBatchDispatcher\Tests;

use Illuminate\Events\Dispatcher;
use Orchestra\Testbench\TestCase as Orchestra;
use ReflectionFunction;
use Timmylindh\LaravelBatchDispatcher\LaravelBatchDispatcherServiceProvider;
...
class TestCase extends Orchestra
{
    ...
    {
        return [LaravelBatchDispatcherServiceProvider::class];
    }
